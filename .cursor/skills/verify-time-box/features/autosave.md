...
- Sign in. The header **AutosaveIndicator** appears on the planner and workout tracker (role **status**, labels **Saving…** or **Saved**).
...
- **Workout autosave.** Open **Workouts**. Add **New workout** and name it `Autosave verify` in **Workout name**. Status control beside **Export** cycles through **Saving…** and **Saved**.
