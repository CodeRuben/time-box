...
- **Landing.** Snapshot shows heading **Workout Tracker**, card **Selected Day**, buttons **Export** and **Workout Insights**, and month navigation **Previous month** / **Next month**.
...
- Guest workouts persist in browser localStorage; signed-in users autosave to the verification database.
