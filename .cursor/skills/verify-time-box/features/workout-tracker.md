...
- **Name workout.** New cards start expanded. If collapsed, expand first. `browser_type` into placeholder **Workout name** (e.g. `Verify workout`). Press Tab or click outside. Card shows `Verify workout`.
