...
- **Admin (seeded verify user):** under **Administration**, read static groups **Pages** and **System** and flip a role switch (e.g. **Guest** for **Books**).
...
- **Admin view.** Panel **Administration** shows static groups **Pages** and **System** (not collapsible). Rows include **Planner**, **Workouts**, **Books**, and **New user registration**. Each row has mini switches **Admin**, **User**, **Guest**.
- **Toggle flag.** Flip one **Guest** switch (e.g. for **Books**). Brief **Saving...** may appear in the page intro area. Switch state persists after reload.
